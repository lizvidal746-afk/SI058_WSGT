...
export const options = {
  ...
  summaryTrendStats,
  tags: Object.assign({ test_type: 'performance', endpoint_focus: 'grados', scenario_active: SCENARIO_NAME }, TAGS),
  cloud: cloudOptions(`grados-${SCENARIO_NAME}`),
};
...
export const handleSummary = buildHandleSummary(`grados-${SCENARIO_NAME}`, {
