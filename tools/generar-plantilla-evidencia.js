    ...
    sections: [
        ...
        children: [
          ...
          new Table({
            ...
            rows: [
              ...
              new TableRow({
                children: ['1.', '1.0', '15.05.2026', 'Ingeniería QA', 'VERSIÓN INICIAL', 'E', ''].map(
      ...
      // --- SECCIÓN 3: INTRODUCCIÓN Y DATOS ---
      {
        ...
        children: [
          ...
          new Paragraph(
            'El presente documento contiene el informe de pruebas integrales de rendimiento realizadas al proyecto SI058 - Módulo de Reconocimiento de Grados y Títulos.',
          ),
            ...
            rows: [
              new TableRow({
                children: [
                  ...
                  new TableCell({ children: [new Paragraph('Sistema SIU / SI058')] }),
                ],
              }),
              new TableRow({
                children: [
