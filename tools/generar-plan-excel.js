...
async function crearPlanPruebas() {
  ...
  const casos = [
    ...
    caso(
      ...
      'CP-CAR-02',
      'Carné',
      'Carga Base Orgánica (Multi-IP)',
      'Baseline / Load',
      'npm run perf:carnet:cp02',
    ...
    caso(
      ...
      'CP-CAR-03',
      'Carné',
      'Escalabilidad Multi-PC',
      'Stress (Ramping)',
      'npm run perf:carnet:stress',
    ...
    caso(
      ...
      'CP-CAR-04',
      'Carné',
      'Límite de Red WAF (Single IP)',
      'WAF Limit',
      'npm run perf:carnet:cp01',
    ...
    caso(
      ...
      'CP-CAR-05',
      'Carné',
      'Saturación Backend (Extreme)',
      'Breakpoint / Stress Extreme',
      'npm run perf:carnet:cp03',
